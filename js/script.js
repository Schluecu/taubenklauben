...
function wiggle() {
  ...
  y.style="transition:all .2s;height:125.5%;top:46.5%;width:25vw;transform:translate(-49%, -50%);@media only screen and (orientation:portrait){width:47%;}";
...
function unwiggle() {
  ...
  y.style="height:125%;top:46%;width:25vw;@media only screen and (orientation:portrait){width:47%;}";
